...
//go:embed template/domain_struct.tmpl
var domainStructTmplSrc string

var domainStructTemplate = template.Must(template.New("domain_struct").Parse(domainStructTmplSrc))
